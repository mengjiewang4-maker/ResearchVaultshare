---
title: "md文件基本格式语法"
source: "https://obsidian.md/zh/help/syntax"
author:
published:
created: 2026-05-08
description: "创建第一篇笔记 - Obsidian 中文帮助"
tags:
  - "clippings"
---
了解如何使用 [Markdown](https://daringfireball.net/projects/markdown/) 对笔记进行基本格式化。如需了解更高级的格式语法，请参阅 [高级格式语法](https://obsidian.md/zh/help/advanced-syntax) 。
...
要创建标题，在标题文本前添加最多六个 `#` 符号。 `#` 符号的数量决定标题的级别（如 [大纲](https://obsidian.md/zh/help/plugins/outline) 中所示）。
...
文本格式也可以通过 [编辑相关的快捷键](https://obsidian.md/zh/help/editing-shortcuts) 来应用。
...
Obsidian 支持两种笔记间 [内部链接](https://obsidian.md/zh/help/links) 的格式：
...
你也可以通过链接到 [Obsidian URI](https://obsidian.md/zh/help/uri) 来创建指向其他仓库中文件的外部链接。
...
> [!tip]- 提示
> 如果你想添加仓库内的图片，也可以 [在笔记中嵌入图片](https://obsidian.md/zh/help/embeds#%E5%9C%A8%E7%AC%94%E8%AE%B0%E4%B8%AD%E5%B5%8C%E5%85%A5%E5%9B%BE%E7%89%87) 。
...
> [!tip]- 提示
> 你可以通过在引用的第一行添加 `[!info]` 来将引用转换为 [标注](https://obsidian.md/zh/help/callouts) 。
...
你可以使用 `Shift+Enter` 在有序列表中插入 [换行](https://obsidian.md/zh/help/syntax#%E6%8D%A2%E8%A1%8C) 而不改变编号。
...
> [!info]+ PrismJS 与编辑视图
> [源码模式](https://obsidian.md/zh/help/edit-and-read#%E6%BA%90%E7%A0%81%E6%A8%A1%E5%BC%8F) 和 [实时预览](https://obsidian.md/zh/help/edit-and-read#%E5%AE%9E%E6%97%B6%E9%A2%84%E8%A7%88) 不支持 PrismJS，可能会以不同方式渲染语法高亮。
...
使用 [脚注视图](https://obsidian.md/zh/help/plugins/footnotes) 查看笔记中的所有脚注。
...
要了解更多高级格式语法，如表格、图表和数学表达式，请参阅 [高级格式语法](https://obsidian.md/zh/help/advanced-syntax) 。

要了解 Obsidian 如何解析 Markdown，请参阅 [Obsidian 风格的 Markdown 语法](https://obsidian.md/zh/help/obsidian-flavored-markdown) 。
